    ...
    <div style={{ padding: '10px 12px 4px' }}>
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
          <div style={{
            width: 36, height: 36, backgroundColor: '#81b64c', borderRadius: 10,
          ...
          <div>
            <p style={{ fontSize: 15, fontWeight: 800, color: '#f0ede8', lineHeight: 1.1 }}>Puzzles</p>
            <p style={{ fontSize: 10, fontWeight: 600, color: '#7d7a75', letterSpacing: 1.2 }}>COIPO CHESS</p>
          </div>
        </div>
        <div style={{ display: 'flex', flexDirection: 'row', gap: 6 }}>
          <button onClick={onOpenStats} className="btn-secondary" style={{ padding: 8, borderRadius: 10 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b5b1ab" strokeWidth="2">
              <path d="M18 20V10M12 20V4M6 20v-6"/>
            </svg>
          </button>
          <button onClick={onOpenSettings} className="btn-secondary" style={{ padding: 8, borderRadius: 10 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b5b1ab" strokeWidth="2">
